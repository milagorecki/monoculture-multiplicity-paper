...
- For tableshift, we created a fork that primarily allows to get the full i.i.d. dataset rather than specific splits. 
    1. download the fork [here](https://anonymous.4open.science/r/tableshift-custom-B278/README.md)
    2. in the tableshift folder, install the package using ``` pip install -e .```
    to install remaining dependencies. 
- To extend folktexts, we created a custom fork, available [here](https://anonymous.4open.science/r/folktexts-custom-DCC8/README.md)
    1. download the fork
